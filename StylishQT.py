...
from PyQt5.QtWidgets import (QWidget, QButtonGroup, QLabel, QSlider, QSpinBox, QDoubleSpinBox, QGridLayout, QPushButton, QGroupBox, QStyle,
                             QLineEdit, QVBoxLayout, QHBoxLayout, QComboBox, QMessageBox, QTabWidget, QCheckBox, QRadioButton, QStyleOptionSlider,
                             QFileDialog, QProgressBar, QTextEdit, QStyleFactory, QMainWindow, QMenu, QAction, QGraphicsDropShadowEffect)
...
class cleanButton(QtWidgets.QPushButton):
    ...
    def __init__(self, label = '', parent = None):
        ...
        StyleSheet = ("QPushButton {color:#0000CC;font: bold;background-color: qlineargradient( x1:0 y1:0, x2:1 y2:0, stop:0 #DAECD7, stop:1 #CEECEE);border-radius: 8px;}" 
...
class checkableButton(QtWidgets.QPushButton):
    ...
    def __init__(self, Icon_path = "", label = '', background_color = "#FFE5CC", parent = None):
        ...
        StyleSheet = "QPushButton {color:white;background-color: " + background_color + ";}QPushButton:hover:!pressed {color:white;background-color: #CCFFFF;}\
