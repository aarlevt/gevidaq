...
#        master_data_analysis.addWidget(imageanalysis_weight_Container, 2, 1, 1,1)
    ...
    def substract_background(self):
        ...
        popt, pcov = curve_fit(bg_func, self.cam_time_label, self.background_trace, bounds = parameter_bounds, maxfev = 500000)
        ...
        p01, = ax1.plot(self.cam_time_label, self.background_trace, color = (0, 0, 0.4), linestyle = 'None', marker = 'o', markersize = 0.5, markerfacecolor = (0, 0, 0.9), label = "Raw background")
        p02, = ax1.plot(self.cam_time_label, self.background_trace_smoothed, color = (0.9, 0, 0), label = "Smoothed background")
