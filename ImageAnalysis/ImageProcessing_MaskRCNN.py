...
#                        RawimageCleared = Rawimage.copy()
    ...
    def MergeDataFrames(self, cell_Data_1, cell_Data_2, method = 'TagLib'):
        ...
        """
        if method == 'TagLib':
            self.cell_Data_1 = cell_Data_1.add_suffix('_Tag')
            self.cell_Data_2 = cell_Data_2.add_suffix('_Lib')
            cell_merged_num = 0
            ...
            for index_Data_1, row_Data_1 in self.cell_Data_1.iterrows():
                ...
                DataFrame_of_same_coordinate_Data2 = self.cell_Data_2\
                    [self.cell_Data_2['ImgNameInfor_Lib'].str.contains(ImgNameInforString_Data1[ImgNameInforString_Data1.index('_R')+1:len(ImgNameInforString_Data1)])]
    ...
    def register_single_cell(self, input_series):
        """
        ...
        if len(intersection_Area_percentage_list) > 0:
            ...
            if max(intersection_Area_percentage_list) > 0.6:
                ...
                pd_data_of_single_cell = pd.concat((self.cell_Data_1.loc[input_series[0]], self.cell_Data_2.loc[Merge_data2_index]), axis = 0)
