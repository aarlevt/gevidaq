...
import numpy as np
import os
from MaskRCNN.Configurations.GitInstallPath import GitPath
def CreatePaths():
    path, _= os.path.split(GitPath)
    return path
...
class Config(object):
    ...
    model_dir      = os.path.join(CreatePaths(), 'Data\\Training\\Results')
    ROTATION_CACHE = os.path.join(CreatePaths(), 'Data\\Cache\\Rotation')
