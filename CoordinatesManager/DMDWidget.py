...
class DMDWidget(QWidget):
    ...
    def init_gui(self):
        ...
        self.back_load_mask_container_index0.clicked.connect(lambda:self.load_mask_container_stack.setCurrentIndex(0))
        ...
        load_mask_container_layout_2.addWidget(self.back_load_mask_container_index0, 2, 1)
    ...
    def receive_mask_coordinates(self, sig_from_CoordinateWidget):
        ...
        for each_mask_key in sig_from_CoordinateWidget:
            ...
            mask_single_frame = ProcessImage.CreateBinaryMaskFromRoiCoordinates(list_of_rois_transformed, \
    ...
    def transform_coordinates(self, list_of_rois, for_which_laser):
        ...
        for roi in list_of_rois:
            new_list_of_rois.append(CoordinateTransformations.transform(roi, self.transform[for_which_laser]))
    ...
    def set_settings(self):
        ...
        if self.ALP_ALP_BIN_MODE_Combox.currentText() == "ALP_BIN_NORMAL":
            self.DMD_actuator.DMD.SeqControl(controlType = ALP_BIN_MODE, value = ALP_BIN_NORMAL)
